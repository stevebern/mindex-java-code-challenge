...
public class Employee {
    ...
    public String toString() {
        return "{" +
                " employeeId ='" + getEmployeeId() + "'" + ", firstName ='" + getFirstName() + "'" +
                ", lastName ='" + getLastName() + "'" + ", position ='" + getPosition() + "'" +
                ", department ='" + getDepartment() + "'" + ", directReports ='" + getDirectReports() + "'" +
                "}";
    }
}
